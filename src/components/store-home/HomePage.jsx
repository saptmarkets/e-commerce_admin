  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 font-sans pr-4">
        ...
        {/*  ====================================================== Main Slider ====================================================== */}
        {/* 
        // OBSOLETE: Main Slider functionality has been replaced by the Banners system
        // This section is no longer used and should be removed from the UI
        ...
        */}
        ...
        {/* 
        // OBSOLETE: Discount Coupon functionality has been moved to the Offers Settings tab
        // This section is no longer used and should be removed from the UI
        <div className="col-span-12 md:col-span-12 lg:col-span-12 mt-5">
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
            <FiSettings className="mt-1 mr-2" />
        ...
        */}
        ...
        {/*  ====================================================== Promotion Banner ===================================================== */}
        {/* 
        // OBSOLETE: Promotion Banner functionality has been moved to the Banners system
        // This section is no longer used and should be removed from the UI
        <div className="col-span-12 md:col-span-12 lg:col-span-12">
        ...
        */}
        ...
        {/*  ====================================================== Featured Categories ====================================================== */}
        {/* 
        // OBSOLETE: Featured Categories functionality has been moved to the Homepage Sections tab
        // This section is no longer used and should be removed from the UI
        ...
        */}
        ...
        {/*  ====================================================== Popular Products ====================================================== */}
        {/* 
        // OBSOLETE: Popular Products functionality has been moved to the Homepage Sections tab
        // This section is no longer used and should be removed from the UI
        <div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-15">
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3 relative">
            <FiSettings className="mt-1 mr-2" />
        ...
        */}
        ...
        {/* 
        // OBSOLETE: Daily Needs functionality has been moved to the Homepage Sections tab
        // This section is no longer used and should be removed from the UI
        <div
        ...
        */}
        ...
        {/* 
        // OBSOLETE: Feature Promo functionality has been moved to the Homepage Sections tab
        // This section is no longer used and should be removed from the UI
        <div
          className={`col-span-12 md:col-span-12 lg:col-span-12 ${
